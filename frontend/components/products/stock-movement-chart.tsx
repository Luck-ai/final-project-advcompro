...
export function StockMovementChart({ productId, stockMovements: propStockMovements }: StockMovementChartProps) {
    ...
    if (!movements || movements.length === 0) {
        return (<div className="flex items-center justify-center h-[400px] text-center">
        <div>
          ...
          <ChartContainer config={{
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData}>
                  ...
                  <XAxis dataKey="index" type="number" domain={[0, "dataMax"]} tickFormatter={(val: number) => {
            ...
            return null;
                  ...
                  <Line type="monotone" dataKey="stock" stroke="var(--color-chart-3)" strokeWidth={2} dot={{ fill: "var(--color-chart-3)", strokeWidth: 2, r: 4 }} activeDot={{ r: 6, stroke: "var(--color-chart-3)", strokeWidth: 2 }}/>
              </LineChart>
            </ResponsiveContainer>
          </ChartContainer>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            ...
            const displayDate = movement.transaction_date || movement.created_at;
            return (<TableRow key={movement.id || index}>
                    <TableCell>
                      <div>
