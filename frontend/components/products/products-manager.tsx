    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent>
            ...
            <div className="text-2xl font-bold">THB {mockProducts.reduce((s, p) => s + p.price * p.stock, 0).toLocaleString()}</div>
      ...
      <div className="space-y-4">
        ...
        {view === "grid" ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((product) => (<Card key={product.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      <span className="font-semibold">THB {product.price}</span>
                    </div>
                    <div className="flex items-center space-x-2">
          ...
          </div>) : (<div className="space-y-2 bg-muted/30 rounded-md p-2">
            ...
            {filtered.map((p, idx) => (<div key={p.id} className="grid grid-cols-12 gap-4 items-center py-3 px-3 border-b">
                ...
                <div className="col-span-1">THB {p.price}</div>
