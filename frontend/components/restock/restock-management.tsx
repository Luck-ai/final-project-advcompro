...
export function RestockManagement() {
    ...
    return (<div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <SummaryCard>
            ...
            <CardContent>
              <div className="text-2xl font-bold">THB {loading ? "..." : summary.total_pending_value.toLocaleString()}</div>
    ...
    {showHistory ? (<PurchaseOrders />) : (<AutoReorderSuggestions onOrderCreated={loadSummary} />)}
    </div>);
}
