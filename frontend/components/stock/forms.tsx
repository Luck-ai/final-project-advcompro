...
export function SupplierForm({ onSave, onCancel, open, onOpenChange, suppliers, initial, onUpdate, }: {
    onSave: (s: {
        name: string;
        email?: string;
        phone?: string;
...
export function CategoryForm({ onSave, onCancel, open, onOpenChange, categories, initial, onUpdate, }: {
    onSave: (c: {
        name: string;
        description?: string;
    }) => void;
